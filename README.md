...
<table>
  ...
  <tr>
    ...
    <td width="40%" valign="top" align="center">
      <img src="assets/screen_4.png" alt="Интерфейс и анализ" width="100%">
    </td>
  </tr>

  <!-- РЯД 2: ОЧЕРЕДЬ И ОТСЕВ ХЛАМА -->
  <tr>
    <td width="60%" valign="top">
      ...
      <br>
      <h3>🧠 Умный ИИ-фильтр хлама</h3>
      <p>Нейросеть безжалостно отсеивает сомнительные предложения. Сетевой маркетинг, крипто-схемы, инфобизнес, эзотерика и просто «размытые» вакансии-пустышки автоматически отправляются в корзину.</p>
    </td>
    <td width="40%" valign="top" align="center">
      <img src="assets/screen_5.png" alt="Очередь и мгновенный отсев" width="100%">
    </td>
  </tr>

  <!-- РЯД 3: ПИСЬМА И АНТИРАБСТВО -->
  <tr>
    <td width="60%" valign="top">
      <h3>✍️ Сопроводительные письма «под ключ»</h3>
      <p>Для каждой одобренной вакансии ИИ создает профессиональный отклик в 2–3 абзаца. Нейросеть берет ваш реальный опыт из профиля и ювелирно адаптирует его под стек и требования конкретного работодателя.</p>
      <br>
      <h3>🕒 Защита от переработок (Анти-рабство)</h3>
      <p>ИИ внимательно вчитывается в условия. Если работодатель требует рабский график (более 45 часов в неделю) или пытается навязать неоплачиваемые переработки, ассистент мгновенно забракует предложение.</p>
    </td>
    <td width="40%" valign="top" align="center">
      <img src="assets/screen_9.png" alt="Генерация писем" width="100%">
    </td>
  </tr>
  ...
  <tr>
    <td width="60%" valign="top">
      <h3>🌍 Жесткий гео-контроль</h3>
      <p>Незаменимая фича для тех, кто работает удаленно из-за границы. Ассистент автоматически заблокирует вакансии, которые требуют строгого физического нахождения на территории РФ или содержат технические запреты на работу через корпоративный VPN.</p>
      <br>
      <h3>📋 Удобный журнал результатов</h3>
      <p>Всё разложено по полочкам: Одобренные и Отклоненные. Причем для каждого отказа ИИ пишет честную и понятную причину, почему вакансия мимо. Журнал автоматически очищается (хранит до 50 записей).</p>
    </td>
    <td width="40%" valign="top" align="center">
      <img src="assets/screen_7.png" alt="Журнал результатов с причинами" width="100%">
    </td>
  </tr>
</table>
